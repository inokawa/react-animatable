import{j as e}from"./jsx-runtime-B4y4_ZYH.js";import{r as s}from"./iframe-2ubdBSbI.js";import{u}from"./useAnimation-CDt8DyLI.js";import"./preload-helper-D9Z9MdNV.js";import"./useLatestRef-BUZ-4JWQ.js";function P(n){return r=>{n.forEach(t=>{typeof t=="function"?t(r):t!=null&&(t.current=r)})}}const R=(n,r)=>{let t=null;return(...i)=>{t!=null&&clearTimeout(t),t=setTimeout(()=>{t=null,n(...i)},r)}},F={component:u},f={render:()=>{const[n,r]=s.useState(1e3),[t,i]=s.useState(2),[o,m]=s.useState("alternate"),[l,d]=s.useState("cubic-bezier"),[h,v]=s.useState([.65,0,.35,1]),[p,b]=s.useState([20,"end"]),[z,V]=s.useState(0),[N,B]=s.useState(0),g=u([{transform:"translateX(0px)"},{transform:"translateX(100px) scale(2.0)",fill:"red"}],{duration:n,easing:l==="cubic-bezier"?`cubic-bezier(${h.join(",")})`:l==="steps"?`steps(${p.join(",")})`:l,direction:o,iterations:t,delay:z,endDelay:N});return s.useEffect(()=>{g.play()},[n,l,h,p,t,o,z]),e.jsxs("div",{children:[e.jsx("svg",{width:600,height:300,viewBox:"0 0 600 300",children:e.jsx("g",{transform:"translate(100, 100)",children:e.jsx("g",{ref:g,fontSize:"24px",fill:"dimgray",children:e.jsx("text",{children:"Hello world"})})})}),e.jsxs("div",{children:[e.jsx("button",{onClick:()=>g.play(),children:"play"}),e.jsx("button",{onClick:g.pause,children:"pause"}),e.jsx("button",{onClick:g.reverse,children:"reverse"}),e.jsx("button",{onClick:g.finish,children:"finish"})]}),e.jsx("div",{children:e.jsxs("label",{children:["duration:",e.jsx("input",{type:"number",min:0,value:n,onChange:a=>{r(Number(a.target.value))}}),"ms"]})}),e.jsx("div",{children:e.jsxs("label",{children:["iteration:",e.jsx("input",{type:"number",min:1,value:t,onChange:a=>{i(Number(a.target.value))}})]})}),e.jsxs("div",{children:["easing:",["linear","ease","ease-in","ease-out","ease-in-out"].map(a=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",value:a,checked:l===a,onChange:c=>{d(c.target.value)}}),a]},a)),e.jsxs("label",{children:[e.jsx("input",{type:"radio",value:"cubic-bezier",checked:l.indexOf("cubic-bezier")===0,onChange:a=>{d(a.target.value)}}),"cubic-bezier(",h.map((a,c)=>e.jsx("input",{value:a,type:"number",step:.01,min:0,max:1,onChange:A=>{d("cubic-bezier"),v(M=>{const D=[...M];return D[c]=Number(A.target.value),D})}},c)).reduce((a,c,A)=>(a.push(c),A!==h.length-1&&a.push(","),a),[]),")"]}),e.jsxs("label",{children:[e.jsx("input",{type:"radio",value:"steps",checked:l.indexOf("steps")===0,onChange:a=>{d(a.target.value)}}),"steps(",e.jsx("input",{type:"number",step:1,min:1,value:p[0],onChange:a=>{d("steps"),b(c=>[Number(a.target.value),c[1]])}}),",",e.jsx("select",{value:p[1],onChange:a=>{d("steps"),b(c=>[c[0],a.target.value])},children:["jump-start","jump-end","jump-none","jump-both","start","end"].map(a=>e.jsx("option",{value:a,children:a},a))}),")"]})]}),e.jsxs("div",{children:["direction:",["normal","reverse","alternate","alternate-reverse"].map(a=>e.jsxs("label",{children:[e.jsx("input",{type:"radio",value:a,checked:o===a,onChange:c=>{m(c.target.value)}}),a]},a))]}),e.jsx("div",{children:e.jsxs("label",{children:["delay:",e.jsx("input",{type:"number",min:0,value:z,onChange:a=>{V(Number(a.target.value))}}),"ms"]})}),e.jsx("div",{children:e.jsxs("label",{children:["endDelay:",e.jsx("input",{type:"number",min:0,value:N,onChange:a=>{B(Number(a.target.value))}}),"ms"]})}),e.jsx("div",{children:e.jsxs("label",{children:["time:",e.jsx("input",{type:"range",defaultValue:"0",min:0,max:100,onChange:a=>{g.setTime(c=>c*(Number(a.target.value)/100))}})]})}),e.jsx("div",{children:e.jsxs("label",{children:["playback rate:",e.jsx("input",{type:"number",min:-100,max:100,defaultValue:1,onChange:a=>{g.setPlaybackRate(Number(a.target.value))}})]})})]})}},$=({value:n,i:r,height:t,keep:i})=>{const o={height:`${n}px`,transform:`translateY(-${n}px)`,opacity:String(1-r*.025)},m=u(i?l=>[{height:l.height,transform:l.transform,opacity:l.opacity},o]:[o],{duration:150,easing:"ease-out",delay:r*100});return s.useEffect(()=>{m.play()},[n,i]),e.jsx("rect",{ref:m,x:r*20,y:t,width:18,height:0,opacity:o.opacity,fill:"steelblue"})},y={render:()=>{const n=()=>Array.from({length:30}).map(()=>300*Math.random()**2),[r,t]=s.useState(n),[i,o]=s.useState(!1),m=800,l=400,d=10,h=l-d*2,v=()=>t(n());return e.jsxs(e.Fragment,{children:[e.jsxs("div",{children:[e.jsx("button",{onClick:v,children:"refresh"}),e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",checked:i,onChange:p=>{o(p.target.checked),v()}}),"keep"]})]}),e.jsx("div",{children:e.jsx("svg",{width:m,height:l,children:e.jsx("g",{transform:`translate(${d},${d})`,children:r.map((p,b)=>e.jsx($,{i:b,value:p,height:h,keep:i},b))})})})]})}},x={render:()=>{const n=u([{transform:"rotate(0deg)",borderRadius:"1rem"},{transform:"rotate(360deg)",borderRadius:"50%"},{transform:"rotate(720deg)",borderRadius:"1rem"}],{duration:1e3,iterations:1/0,easing:"ease-in-out"}),r=u((t,i)=>[{transform:t.transform},{transform:`translate(${i.x}px, ${i.y}px)`}],{duration:400,easing:"ease-in-out"});return s.useEffect(()=>{n.play();const t=R(i=>{r.play({args:{x:i.clientX,y:i.clientY}})},100);return window.addEventListener("pointermove",t),()=>{window.removeEventListener("pointermove",t)}},[]),e.jsxs("div",{children:[e.jsx("div",{children:"Move mouse cursor."}),e.jsx("div",{ref:r,children:e.jsx("div",{ref:n,style:{position:"fixed",border:"solid 0.1rem #135569",height:"6rem",width:"6rem",top:"-3rem",left:"-3rem"}})})]})}},j={render:()=>{const n=u({transform:"translate3d(400px, 0, 0)"},{duration:800,easing:"ease-in-out"});return s.useEffect(()=>{n.play()},[n]),e.jsxs("div",{children:[e.jsx("button",{onClick:n.reverse,children:"Toggle"}),e.jsx("div",{className:"rail",children:e.jsx("div",{ref:n,className:"block"})}),e.jsx("style",{children:`
.rail {
  border-radius: 4px;
