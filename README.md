...
- Designed for modern web application development.
  ...
  - Easy integration with any UI component libraries, like [Material UI](https://github.com/mui/material-ui), [Chakra UI](https://github.com/chakra-ui/chakra-ui) and the others.
